...
/* Module Version: 5.7 */
/* /usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n pll_x4 -lang verilog -synth lse -arch xo2c00 -type pll -fin 12.288 -fclkop 49.152 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Wed Sep  2 23:42:50 2020 */


`timescale 1 ns / 1 ps
module pll_x4 (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="49.152000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 49.152000
